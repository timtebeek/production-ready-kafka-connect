...
8. Optionally you can https://docs.confluent.io/platform/6.2.1/schema-registry/develop/maven-plugin.html#schema-registry-download[download the Avro schema] from the schema registry using the Schema Registry Maven Plugin, for code generation and use.

9. Once you're done exploring you can shutdown Docker Compose and remove attached volumes
+
[source,bash]
----
